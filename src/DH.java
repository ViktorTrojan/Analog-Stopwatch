...
public class DH {
    ...
    public static void drawString(Graphics2D g2, String s, float x, float y, String fontName, int f, float size) {
        if (!fontName.isEmpty()) {
            g2.setFont(new Font(fontName, f, (int) size));
        } else {
            g2.setFont(new Font("Calibri", f, (int) size));
        }
